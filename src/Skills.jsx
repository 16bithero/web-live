...
export default function Skills() {
    return (
        <>
            <Accordion defaultExpanded style={{ backgroundColor: "#fe7a5b", boxShadow: "5px 5px 0 black", marginBottom: "1em" }}>
            ...
            <br />
            <Accordion style={{ backgroundColor: "#06d2ff", boxShadow: "5px 5px 0 black", marginBottom: "1em" }}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}
                    aria-controls="panel1a-content"
                    id="panel1a-header" className='acc-text'>ux/ui + design</AccordionSummary>
                <AccordionDetails style={{ lineHeight: "1em"}}>Figma, Mockups and Wireframing, Website Usability Tests, Adobe Creative Suite</AccordionDetails>
            </Accordion>
            <br />
            <Accordion style={{ backgroundColor: "#14d860", boxShadow: "5px 5px 0 black", marginBottom: "1em" }}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}
                    aria-controls="panel1a-content"
